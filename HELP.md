...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.5.14-SNAPSHOT/reference/web/spring-hateoas.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.5.14-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Flyway Migration](https://docs.spring.io/spring-boot/3.5.14-SNAPSHOT/how-to/data-initialization.html#howto.data-initialization.migration-tool.flyway)
